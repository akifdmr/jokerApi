...
$PosXML .= '<TransactionId>' . $SiparID . '</TransactionId>';
$PosXML .= '<CurrencyAmount>' . $Tutar . '</CurrencyAmount>';
$PosXML .= '<CurrencyCode>' . $TutarKodu . '</CurrencyCode>';
$PosXML .= '<Pan>' . $KartNo . '</Pan>';
$PosXML .= '<Expiry>' . $KartYil . $KartAy . '</Expiry>'; //3D Secure işyerlerimizin bu parametreyi kullanmasına lüzum yoktur.
$PosXML .= '<Cvv>' . $KartCvv . '</Cvv>';
$PosXML .= '<TransactionDeviceSource>0</TransactionDeviceSource>';
